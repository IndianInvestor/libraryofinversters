...
Verify that a Macintosh version of Python 2.7, 3.6, 3.7, and/or 3.8 is installed.

2. Installing the eigFunc Package

A. Change to the directory that contains the file setup.py and the subdirectory eigFunc. 
...
In the following directions, replace MR/v99 by the directory on the target machine where MATLAB is installed, or MR by the directory where the MATLAB Runtime is installed.
...
The eigFunc package is on your Python path. To import it into a Python script or session, 
execute:
