---
title: "Topographic map clipped by coastlines in Python (codes included)"
date: 2020-05-21
tags: [maps, clipped, python, geospatial data visualization, geospatial data visualization python]
...
In this post, we demonstrate how to plot the clipped relief map in Python. For the previous post on "Plotting the geospatial data clipped by coastlines in Python", see [here](https://www.earthinversion.com/geophysics/plotting-the-geospatial-data-clipped-by-coastlines-in-python/). Here we use the same approach but instead of the geospatial dataset, we use the 1-arc minute topographic map we used in the [previous plot](https://www.earthinversion.com/Shaded-topo-map-python/).
...
<figure class="half">
	<img width="400" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/station_map_masked.png">
    <img width="400" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/station_map_masked_reverse.png">
</figure>
...
## Basemap plot after clipping out the sea part
...
## Basemap plot after clipping out the land part
