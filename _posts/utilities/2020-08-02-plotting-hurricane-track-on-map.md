---
title: "Plotting track and trajectory of tropical cyclones on a topographic map in Python (codes included)"
date: 2020-07-10
tags:
  [
    hurricane track,
...
excerpt: "Short demonstration of how to plot the track or trajectory of a hurricane on a map. Codes are included."
classes:
  - wide
...
sidebar:
  nav: "all_posts_list"
header:
  teaser: "https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map.png"
authors: balajiseela
category: utilities
---

<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map.png">
...
- `Basemap` is the [matplotlib](/techniques/advanced-2D-plots-with-matplotlib/) library for plotting 2D data on map,
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp1.png">
</p>
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp2.png">
</p>
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp3.png">
</p>
...
- read the data file as a [pandas](/utilities/how-to-start-using-pandas-immediately-for-earth-data-analysis/) data frame.
- extract the `year` info from the filename
- we "capitalize" the track name
- get longitude and latitude as [numpy](/utilities/introduction-to-scientific-computing-using-numpy-python/) array
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp4.png">
</p>
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp5.png">
</p>
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp6.png">
</p>
...
<p align="center">
  <img width="80%" src="https://raw.githubusercontent.com/earthinversion/earthinversion-images/main/images/hurricane-track/map-tmp7.png">
</p>
